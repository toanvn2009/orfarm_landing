...
class Lionthemes_Categorytabs_Element extends \Elementor\Widget_Base {
	...
	protected function render() {
		...
		?>
		<div class="categories-tabs-widget <?php echo esc_attr($settings['el_class']); ?>  <?php echo esc_attr($settings['product_tab_style']); ?>"> 
						...
						<a href="javascript:void(0)">
							<?php if($item['tab_icon'] && $item['tab_icon']['url']){ ?>
								<span class="cate-icon">
									<img src="<?php echo esc_url($item['tab_icon']['url']); ?>" alt="<?php echo esc_attr($tab_name); ?>" />
								</span>
							<?php } ?>
							<span class="cat-name">
