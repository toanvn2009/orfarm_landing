...
$table_text = get_option( 'yith_woocompare_table_text', __( 'Compare products', 'orfarm' ) );
...
<head>
	...
	<link rel="stylesheet" href="//fonts.googleapis.com/css?family=Rubik:300,400,500,700,900,300italic,400italic,500italic,700italic,900italic&display=swap&ver=1621309371"/>
	...
	<link rel="stylesheet" href="<?php echo esc_url( $this->stylesheet_url() ).'?v=932342'; ?>" type="text/css"/>
...
<h1>
	...
	if ( ! $is_iframe ) :
		?>
		<a class="close" href="#"><?php esc_html_e( 'Close window [X]', 'orfarm' ); ?></a><?php endif; ?>
</h1>
	...
	<table class="compare-list" cellpadding="0" cellspacing="0" <?php if ( empty( $products ) ) {
		...
		<?php if ( empty( $products ) ) : ?>
			...
			<tr class="no-products">
				<td><?php esc_html_e( 'No products added in the compare table.', 'orfarm' ); ?></td>
			</tr>
			...
			<tr class="remove">
				...
				foreach ( $products as $product_id => $product ) :
					...
					<td class="<?php echo esc_attr( $product_class ); ?>">
						...
						?>"
								data-product_id="<?php echo esc_attr( $product_id ); ?>"><?php esc_html_e( 'Remove', 'orfarm' ); ?>
